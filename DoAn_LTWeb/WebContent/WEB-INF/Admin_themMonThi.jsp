...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<title>Triple | Pages - Admin Them Mon Thi</title>
	...
	<script src="./Admin_themMonThi.js" type="text/javascript"></script>
        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar navbar-collapse collapse">
                <ul class="page-sidebar-menu page-sidebar-menu-closed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/ChuyenTrangThongTinCaNhan">
                            <i class="icon-user"></i>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="${pageContext.request.contextPath}/ChuyenTrangThemTaiKhoan">
                                    <i class=""></i> Thêm Tài Khoản</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/ChuyenTrangXemTaiKhoan">
                                    <i class=""></i> Xem Tài Khoản</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
                        <a href="javascript:;">
                            <i class="icon-docs"></i>
                            <span class="title">Quản Lý Môn Thi</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/ChuyenTrangThemMonThi">
                                    <i class=""></i> Thêm Môn Thi</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/ChuyenTrangXemSuaMonThi">
                                    <i class=""></i> Xem/Sửa Môn Thi</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <div class="profile-sidebar">
                            <div class="portlet light profile-sidebar-portlet">
                                <div class="profile-userpic">
                                    <img id="imgg" name="imgg" src="" class="img-responsive">
                                </div>
                                    ...
                                    <div class="portlet light">
                                        <div class="portlet-title tabbable-line">
                                            <div class="caption caption-md">
                                                ...
                                                <span class="caption-subject font-blue-madison bold uppercase">Thêm Môn Thi</span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane active" id="tab_1_1">
                                                    <form role="form">
                                                        <div class="form-group">
                                                            <label class="control-label">Tên Môn Thi</label>
                                                            <input id="TenMonThi" name="TenMonThi" type="text" placeholder="Môn Thi" class="form-control">
                                                        </div>

                                                        <div class="margiv-top-10">
                                                            <a id="btnThem" name="btnThem" class="btn green-haze">
                                                                    Thêm </a>
                                                            <a id="btnHuy" name="btnHuy" class="btn default">
                                                                    Hủy </a>
                                                        </div>
                                                    </form>
                                                </div>
