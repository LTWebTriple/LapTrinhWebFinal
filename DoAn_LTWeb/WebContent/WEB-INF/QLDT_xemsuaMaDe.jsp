...
<title>Triple | Pages - Xem/Sửa Mã Đề</title>
...
<script src="./ShowDeThi.js" type="text/javascript"></script>
</head>
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li><a href="${pageContext.request.contextPath}/ChuyenTrangQLDTThongTinCaNhan"> <i
					...
					<li class="active"><a href="javascript:;"> <i
						...
						<ul class="sub-menu">
							<li class="active"><a href="${pageContext.request.contextPath}/ChuyenTrangXemSuaMaDe"> <i
									class=""></i>Xem/Sửa Mã Đề
							</a></li>
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangThemMaDe"> <i
									class=""></i> Thêm Mã Đề
							</a></li>
						</ul></li>
					<li><a href="javascript:;"> <i class="icon-calendar"></i>
						...
						<ul class="sub-menu">
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangXoaLichThi"> <i
									class=""></i> Xem/Sửa/Xóa Lịch Thi
							</a></li>
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangTaoLichThi"> <i
									class=""></i> Thêm Lịch Thi
							</a></li>
						</ul></li>
				</ul>
			</div>
										...
										<div class="portlet-title tabbable-line">
											<div class="caption caption-md">
												<i class="icon-globe theme-font hide"></i> <span
													class="caption-subject font-blue-madison bold uppercase">Danh
													Sách Đề Thi</span>
											</div>
										</div>
