...
<title>Triple | Pages - Admin Xem Tai Khoan</title>
...
<script src="./Admin_xemTaiKhoan.js" type="text/javascript"></script>
</head>
<body
				...
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li class="active"><a href="javascript:;"> <i
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href=""> <i class=""></i> Xem Tài Khoản
							</a></li>
						</ul></li>
										...
										<div class="portlet-title tabbable-line">
											<div class="caption caption-md">
												<i class="icon-globe theme-font hide"></i> <span
													class="caption-subject font-blue-madison bold uppercase">Xem
													Tài Khoản</span>
											</div>
										</div>
