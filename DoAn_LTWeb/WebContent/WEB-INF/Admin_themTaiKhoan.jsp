...
<title>Triple | Pages - Admin Them Tai Khoan</title>
...
<script src="./Admin_themTaiKhoan.js"></script>
</head>
<body
			...
			<div class="page-sidebar navbar-collapse collapse">
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li class="active"><a href="javascript:;"> <i
						...
						<ul class="sub-menu">
							<li class="active"><a href=""> <i class=""></i> Thêm Tài
									Khoản
							</a></li>
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangXemTaiKhoan">
							 <i class=""></i> Xem Tài Khoản
							</a></li>
						</ul></li>
					<li><a href="javascript:;"> <i class="icon-docs"></i> <span
						...
						<ul class="sub-menu">
							...
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangXemSuaMonThi">
							 <i class=""></i> Xem/Sửa Môn Thi
							</a></li>
						</ul></li>
				</ul>
			</div>
												...
												<div class="tab-pane active" id="tab_1_1">
													<form role="form" action="#">
														<div class="form-group">
															...
															<input id="TenTaiKhoan" name="TenTaiKhoan" type="text" placeholder="Tên Tài Khoản" class="form-control">
														</div>
														<div class="form-group">
															<label class="control-label">Mật Khẩu</label>
															<input id="MatKhau" name="MatKhau" type="text" placeholder="Mật Khẩu" class="form-control">
														</div>
														<div class="form-group">
															<label class="control-label">Họ Và Tên</label>
															<input id="HoVaTen" name="HoVaTen" type="text" placeholder="Họ Và Tên"
																class="form-control">
														</div>
														<div class="form-group">
															<label class="control-label">Ngày Sinh</label>
															<input id="NgaySinh" name="NgaySinh" type="text" placeholder="Ngày Sinh"
																class="form-control">
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<input id="CMND" name="CMND" type="text" placeholder="Số CMND" class="form-control">
														</div>
														<div id="MonThi">
														</div>
														<div id="Quyen">
														...
														<div class="margiv-top-10">
															<!-- <a href="" id="btnImport" name="btnImport" class="btn green-haze">Import </a> -->
															<a id="btnThem" name="btnThem" href="" class="btn green-haze"> Thêm </a> 
															<a id="btnHuy" name="btnHuy" href=""
