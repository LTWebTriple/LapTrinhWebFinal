                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_1_1">
                                                    <form role="form" action="">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Mã Câu Hỏi</label>
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <button id="CapNhatCauHoi"  class="btn green-haze" style="margin-bottom: 10px;">
                                                                           Cập nhật nội dung câu hỏi </button> 
                                                        <div class="form-group">
                                                                ...
                                                                <div class="Cautraloi">
                                                                    <div class="col-md-9">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="IDCauTraLoi" style="display:none;" type="text"  placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <label>
                                                   ...
                                                   <div class="col-md-12">
                                                     ...
                                                     <a href="${pageContext.request.contextPath}/QLNHCH_ToThongKeCauhoi">
                                                      <button class="btn green-haze" style="margin-bottom: 10px;">
                                                                            Xong </button>   
                                                                            </a> 
                                                   </div>
