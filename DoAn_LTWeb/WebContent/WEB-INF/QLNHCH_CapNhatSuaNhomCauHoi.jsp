...
<body
	...
	<div class="page-container">
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
					...
					<li><a href="javascript:;"> <i class="icon-pencil"></i> <span
                                    ...
                                    <div class="portlet light">
                                        <div class="portlet-title tabbable-line">
                                            <div class="caption caption-md">
                                                ...
                                                <span class="caption-subject font-blue-madison bold uppercase">Thêm Nhóm Câu Hỏi</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_1_1">
                                                    <form role="form" action="QLNHCH_CapNhatNhomCauHoi" method="post">                                                       
                                                    	 <div class="form-group">
                                                            <label class="control-label">Mã Nhóm Câu Hỏi</label>
                                                            <input id="ID" name="ID" type="text" placeholder="" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Tên Nhóm Câu Hỏi</label>
                                                            <input id="NoiDung" name="NoiDung" type="text" placeholder="" class="form-control">
                                                        </div>

                                                        <div class="margiv-top-10">
                                                            <button id="CapNhat" class="btn green-haze" type="submit">
                                                                    Cập nhật </button>
    ...
    <div class="page-footer">
     ...
     <script src="./js/suanhomcauhoi.js" type="text/javascript"></script>
</body>
</html>