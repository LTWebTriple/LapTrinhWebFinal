				...
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li class="active"><a href="javascript:;"> <i class="icon-docs"></i> <span
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="${pageContext.request.contextPath}/CTQLNHCH_SuaNhomCauHoi"> <i class=""></i>Sửa Nhóm Câu Hỏi
							</a></li>
						</ul></li>
				</ul>
			</div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="portlet light">
                                        <div class="portlet-title tabbable-line">
                                            <div class="caption caption-md">
                                                ...
                                                <span class="caption-subject font-blue-madison bold uppercase">Xóa/Sửa Nhóm Câu Hỏi</span>
                                            </div>
                                        </div>
								...
								<tr>									
										...
										<td class="text-center">
											<a href="SuaNhomCauHoi?ID=${row.KindId}&Name=${row.KindName}">
