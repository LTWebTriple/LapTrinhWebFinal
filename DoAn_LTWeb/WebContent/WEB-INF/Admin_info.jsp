...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<title>Triple | Pages - Admin Thông Tin Cá Nhân</title>
	...
	<script src="./ThongTinCaNhan.js"></script>
	</head>
	<body
				...
				<div class="page-sidebar navbar-collapse collapse">
					<ul class="page-sidebar-menu page-sidebar-menu-closed"
						...
						<li><a href="javascript:;"> <i class="icon-wallet"></i> <span
								class="title">Quản Lý Tài Khoản</span> <span class="arrow"></span>
						</a>
							<ul class="sub-menu">
								<li><a href="${pageContext.request.contextPath}/ChuyenTrangThemTaiKhoan"> <i class=""></i> Thêm Tài Khoản
								</a></li>
								<li><a href="${pageContext.request.contextPath}/ChuyenTrangXemTaiKhoan"> <i class=""></i> Xem Tài Khoản
								</a></li>
							</ul></li>
						<li><a href="javascript:;"> <i class="icon-docs"></i> <span
							...
							<ul class="sub-menu">
								<li><a href="${pageContext.request.contextPath}/ChuyenTrangThemMonThi"> <i class=""></i> Thêm Môn Thi
								</a></li>
								<li><a href="${pageContext.request.contextPath}/ChuyenTrangXemSuaMonThi"> <i class=""></i> Xem/Sửa Môn Thi
								</a></li>
							</ul></li>		
					</ul>
				</div>
