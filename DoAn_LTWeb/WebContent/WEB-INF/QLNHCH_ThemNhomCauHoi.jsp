...
<meta charset="UTF-8">
    ...
    <script src="./js/layout.js" type="text/javascript"></script>
     <script src="./js/themnhomcauhoi.js" type="text/javascript"></script>
			...
			<div class="page-sidebar navbar-collapse collapse">
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li class="active"><a href="javascript:;"> <i class="icon-docs"></i> <span
						...
						<ul class="sub-menu">
							<li class="active"><a href="${pageContext.request.contextPath}/CTQLNHCH_ThemNhomCauHoi"> <i class=""></i> Thêm Nhóm Câu Hỏi
							</a></li>
                                                ...
                                                <div class="tab-pane active" id="tab_1_1">
                                                    <form role="form" action="#">                                                       
                                                        <div class="form-group">
                                                            ...
                                                            <input id="NoiDung" type="text" placeholder="Mời điền nhóm câu hỏi" class="form-control">
                                                        </div>

                                                        <div class="margiv-top-10">
                                                            <a id="Them" href="#" class="btn green-haze" type="submit">
                                                                    Thêm </a>
