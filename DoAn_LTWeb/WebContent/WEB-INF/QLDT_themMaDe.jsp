...
<title>Triple | Pages - Thêm Mã Đề</title>
...
<script src="./ThemMaDe.js" type="text/javascript"></script>
</head>
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<ul class="page-sidebar-menu page-sidebar-menu-closed"
					...
					<li><a href="${pageContext.request.contextPath}/ChuyenTrangQLDTThongTinCaNhan"> <i class="icon-user"></i>
							<span class="title">Thông Tin Cá Nhân</span> <span
							class="selected"></span> <span class="arrow"></span>
					</a></li>
					<li class="active"><a href="javascript:;"> <i
							class="icon-docs"></i> <span class="title">Quản Lý Đề Thi</span>
							<span class="arrow"></span>
					</a>
						<ul class="sub-menu">
							<li><a href="${pageContext.request.contextPath}/ChuyenTrangXemSuaMaDe"> <i class=""></i> Xem/Sửa Mã Đề
							</a></li>
							<li class="active"><a href="${pageContext.request.contextPath}/ChuyenTrangThemMaDe"> <i class=""></i> Thêm Mã Đề
							</a></li>
						</ul></li>
													...
													<form role="form" action="#">
														<div class="form-group">
															<label class="control-label">Tên mã đề</label> <input
																type="text" id="TenDeThi" name="TenDeThi" placeholder="" class="form-control">
														</div>
														<div id="LoaiCauHoi">
														</div>
														<div class="form-group">
                                                            <button class="btn green-haze" id="btn-ThemLoai"><i class="fa fa-plus"></i><span>
                                                                Thêm loại câu hỏi</span></button>
														</div>
														<div class="form-group">
															<label class="control-label">Thời gian làm bài</label> <input
																type="text" id="ThoiGian" name="ThoiGian" placeholder="" class="form-control">
														</div>
														<div class="margiv-top-10">
															<a href="" id="btnTaoDe" name="btnTaoDe" class="btn green-haze"> Tạo đề </a> <a
																href="" id="btnHuy" name="btnHuy" class="btn default"> Hủy </a>
														</div>
													</form>
												</div>
