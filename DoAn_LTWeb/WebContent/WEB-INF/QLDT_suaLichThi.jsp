...
<script src="./suaLichThi.js" type="text/javascript"></script>
										...
										<div class="portlet-title tabbable-line">
											<div class="caption caption-md">
												<i class="icon-globe theme-font hide"></i> <span
													class="caption-subject font-blue-madison bold uppercase">Chỉnh sửa
													lịch thi</span>
											</div>
												...
												<div class="tab-pane active" id="tab_1_1">
													<form role="form">
														...
														<div class="form-group">
															<label class="control-label">Thời gian bắt đầu (yyyy-MM-dd hh:mm:ss)</label> <input
																type="text" id="TimeStart" name="TimeStart"
																placeholder="" class="form-control">
														</div>
														<div class="form-group">
															<label class="control-label">Thời gian kết thúc (yyyy-MM-dd hh:mm:ss)</label> <input
																type="text" id="TimeStop" name="TimeStop" placeholder=""
																class="form-control">
														</div>
														<div class="margiv-top-10">
															<a href="" id="btnSuaLich" name="btnSuaLich"
																class="btn green-haze">Xác Nhận</a> <a href=""
																id="btn-Huy" name="btn-Huy" class="btn default">Hủy</a>
														</div>
													</form>
												</div>
